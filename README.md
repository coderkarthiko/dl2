...
dl is a very simple/toy-ish library that I made to understand how NNs work. It uses [momentum](https://distill.pub/2017/momentum/). To get SGD we simply set ![](https://www.codecogs.com/latex/eqneditor.php) equal 0. 
